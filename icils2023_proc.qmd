...
modelo_gen_pendiente <- lmer(S_GENEFF ~ desktops_cmc + tablets_cmc + C_RATSTD + IDI +       desktops_cmc*IDI + S_HOMLIT + S_SEX + (1 + desktops_cmc | CNTRY) + (1 | id_school_unique), data = datos_limpios, control = lmerControl(optimizer = "bobyqa"))
