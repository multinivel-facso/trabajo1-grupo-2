...
El presente estudio busca determinar el efecto que el acceso a Tecnologías de la Información y Comunicación (TIC) en el hogar y el promedio de alfabetización del hogar por escuela de estudiantes de octavo año tiene sobre su autoeficacia digital. Se entiende por autoeficacia digital la actitud que una persona tiene respecto de su habilidad para desempeñarse competentemente en circunstancias relativas a TIC que no domina. Para responder a este objetivo, se construyeron modelos multinivel usando datos de ICILS 2023. Se usó la escuela y el país como variables de anidación. Las variables dependientes son autoeficacia digital general y autoeficacia digital especializada; las variables independientes son la cantidad de aparatos digitales usados en el hogar (nivel 1), el promedio de alfabetización del hogar por escuela (nivel 2) y el Índice de Desarrollo de las TIC (IDI) del país (nivel 3, país). Los resultados señalan que solo una pequeña porción de la varianza de la autoeficacia digital se asocia a la escuela y el país (alrededor del 8%). Sin embargo, el acceso en el hogar tiene un efecto en la autoeficacia: el acceso a computadoras tiene un mayor impacto en la autoeficacia digital que el acceso a tablets; adicionalmente, se descubrió que el efecto del promedio escolar de alfabetización del hogar en la autoeficacia digital tiene direcciones distintas dependiendo del sexo de los estudiantes y que ...
...
Pese a que se ha avanzado en el acceso a dispositivos y conectividad, parecen persistir desigualdades estructurales que condicionan las oportunidades de desarrollo digital de los jóvenes.

Estudios previos han demostrado que factores como el acceso regular a dispositivos digitales en el hogar, la disponibilidad de conectividad de calidad y la presencia de infraestructura tecnológica y el desarrollo de competencias digitales en las escuelas tienen efectos significativos sobre las actitudes de los estudiantes respecto a su competencia digital (Fraillon et al., 2020). Es en esta línea que se delimita como problema de investigación el efecto de factores relacionados con la alfabetización y el acceso a TIC de los estudiantes en diferentes niveles en su autoeficacia, tanto general como especializada. 

Considerando todo lo anterior, se desprende la siguiente pregunta de investigación: ¿De qué manera el acceso a TIC en el hogar y en el país influyen en la autoeficacia digital de los estudiantes? ¿Que rol cumple el promedio escolar de alfabetización del hogar en la autoeficacia digital de los estudiantes?
...
-   Formula, explicación y justificación de:

-   Modelos nulos

-   Modelos prelimiares (en vez de esto podríamos decir que se fue complejizando progresivamente)

-   Modelos con intercepto aleatorio

-   Modelos con pendiente aleatoria

Se realizó un análisis de la distancia de Cook para ver los casos influyentes y se hizo un test de significancia estadística para probar el efecto de borrar un caso en la significancia de los grupos en el modelo, borrando grupos en caso de que corresponda. Posteriormente, se realizó un test de ANOVA para evaluar la diferencia entre los modelos con intercepto aleatorio y los con pendiente aleatoria.
...
sjPlot::tab_model(m4_gen, m4_spec)
...
sjPlot::tab_model(m5_gen, m5_spec)

```

Deja de ser significativo el IDI en la autoeficacia general (muy cercano a la significancia)
