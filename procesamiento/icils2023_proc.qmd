...
Con respecto al ANOVA, se presentan diferencias significativas entre los modelos de intercepto aleatorio y pendiente aleatoria. Tanto en la autoeficacia digital general como la especializada existe una mejora en el $AIC$, y en el indicador $BIC$ hay un mejor puntaje solo en la dimensión general. Se concluye que los modelos con pendiente aleatoria son más explicativos. 
